...
document.addEventListener('DOMContentLoaded', () => {
    // CORRECCIÓN: Llamar a initMap() directamente si el elemento del mapa existe
    if (document.getElementById('map')) {
        initMap();
    }

    // Comentados o removidos, ya que parece que solo aplican a otras páginas del dashboard.
    // initNavigation(); 
