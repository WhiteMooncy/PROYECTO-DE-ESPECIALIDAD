...
<body ID="index-page" data-theme="represa">
    ...
    <div class="presentationSection" data-aos="fade-right">
        ...
        <div class="presentationImg" aria-hidden="true">
            <img src="../../BackEnd/sources/img/represa.webp" alt="Vista aérea de la represa" style="width:100%; border-radius:8px;">
        </div>
    </div>
        ...
        <div class="card-wrapper">
            <ul class="card-list swiper-wrapper">
                <li class="card-item swiper-slide">
                    <img src="../../BackEnd/sources/img/thumb.jpg" alt="Foto - Director de Operaciones" class="card-image">
                ...
                <li class="card-item swiper-slide">
                    <img src="../../BackEnd/sources/img/thumb.jpg" alt="Foto - Jefe de Mantenimiento" class="card-image">
                ...
                <li class="card-item swiper-slide">
                    <img src="../../BackEnd/sources/img/thumb.jpg" alt="Foto - Ingeniera Ambiental" class="card-image">
                ...
                <li class="card-item swiper-slide">
                    <img src="../../BackEnd/sources/img/thumb.jpg" alt="Foto - Operador de Planta" class="card-image">
                ...
                <li class="card-item swiper-slide">
                    <img src="../../BackEnd/sources/img/thumb.jpg" alt="Foto - Relaciones Comunitarias" class="card-image">
